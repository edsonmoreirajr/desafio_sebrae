package com.sebrae.desafio.util;

import com.sebrae.desafio.HateaosUtilsForTests;
import com.sebrae.desafio.controller.ContaController;
...
public class HateoasUtilTest {
    ...
    private static final String LINK_SELF_CREATE = "/api/v1/contas/1";
    ...
    void deveRetornarUmaUriFormadaPorPathEncontradoNoControllerBarraIdDoObjetoInserido() {
        var uri = hateoasUtil.getHateoasSelLik(ContaController.class, 1).toString();
